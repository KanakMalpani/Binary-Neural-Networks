...
def build_nodes() -> list[dict[str, Any]]:
    return [
        ...
        N(
            ...
            ["bnn/kernels/ternary_pack.py", "results/ternary_pack.json", "tests/golden_floors.json"],
            0.9,
        ),
        N(
        ...
        N(
            ...
            "System",
            "Energy bound from wrap latency on main; Lane H RAPL spike is open PR — Windows CLOSED-BY-PROXY.",
            [
                "docs/14_HARDWARE_AND_ENERGY.md",
                "results/energy_bound.json",
                "results/energy_bound_measured.json",
        ...
        N(
            ...
            [
                ...
                "arXiv:2410.16144",
                "https://github.com/KanakMalpani/Binary-Neural-Networks/pull/17",
            ],
            0.95,
        ),
        N(
        ...
        N(
            ...
            "OpenGap",
            "WASM SIMD pedagogy shipped (wasm/, tests/test_wasm_parity.py, PR #24). Not a native-kernel substitute and not a golden gate.",
            [
                "docs/MOONSHOT_DEFERRALS.md",
                "https://github.com/KanakMalpani/Binary-Neural-Networks/pull/24",
            ],
            0.8,
            status="merged",
        ),
        N(
            ...
            "OpenGap",
            "Schema ADR + hashes + ternary meta + safetensors on main (Lane B / PR #18).",
            [
                "docs/MOONSHOT_DEFERRALS.md",
                "docs/BNNPACK_V2_DESIGN.md",
                "https://github.com/KanakMalpani/Binary-Neural-Networks/pull/18",
            ],
            0.85,
            status="merged",
        ),
        N(
            ...
            "OpenGap",
            "bnn.wrap.distill + OptimiseConfig.distill_steps on main (Lane A / PR #19). Full BitDistill-scale KD is still not a golden.",
            [
                "docs/MOONSHOT_DEFERRALS.md",
                "results/distill_sketch.json",
                "https://github.com/KanakMalpani/Binary-Neural-Networks/pull/19",
            ],
            0.85,
            status="merged",
        ),
        N(
            ...
            "OpenGap",
            "wheels.yml + docs ready; OIDC dry-run/attestations shipped. First bnn-lab upload still needs human Trusted Publisher on pypi.org — not live (JSON 404).",
            [
                "docs/PYPI_PUBLISH.md",
                "ROADMAP.md",
                "https://github.com/KanakMalpani/Binary-Neural-Networks/pull/16",
            ],
            0.9,
            status="open",
        ),
        ...
        N(
            ...
            "OpenGap",
            "Linux RAPL probe shipped (PR #22); Windows remains CLOSED-BY-PROXY energy-proxy. Privileged wrap-workload RAPL is a moonshot.",
            [
        ...
        N(
            "hw_wasm",
            "WebAssembly SIMD (pedagogy)",
            "Hardware",
            "Browser pedagogy target shipped with Lane F / PR #24. Not a production GEMM path.",
            [
                "docs/MOONSHOT_DEFERRALS.md",
                "https://github.com/KanakMalpani/Binary-Neural-Networks/pull/24",
            ],
        ...
        N(
            ...
            "OpenGap",
            "search_layer_modes (binary/ternary/skip) + docs/42 on main (W3.T06 / PR #19). Do not invent search goldens.",
            [
                "docs/MOONSHOT_DEFERRALS.md",
                "docs/42_QAT_AND_LAYER_SEARCH.md",
                "https://github.com/KanakMalpani/Binary-Neural-Networks/pull/19",
            ],
            0.8,
            status="merged",
        ...
        N(
            ...
            "OpenGap",
            "Thin pin + bridge recipes instead of a giant submodule. third_party/BITNET_PIN.md + docs/23; PR #17 merged.",
            [
                "docs/MOONSHOT_DEFERRALS.md",
                "docs/23_BITNET_CPP_BRIDGE.md",
                "https://github.com/KanakMalpani/Binary-Neural-Networks/pull/17",
        ...
        N(
            ...
            ["arXiv:2407.07093", "ROADMAP.md", "docs/MOONSHOT_DEFERRALS.md"],
            0.75,
            status="open",
        ),
        N(
...
def build_edges() -> list[dict[str, Any]]:
    return [
        ...
        E(
            ...
            "gap_rapl_windows",
            "blocked_by",
            ["docs/14_HARDWARE_AND_ENERGY.md", "docs/MOONSHOT_DEFERRALS.md"],
            0.7,
        ),
        ...
        E("gap_wasm", "sys_packed_kernels", "alternative_to", ["docs/MOONSHOT_DEFERRALS.md"], 0.5),
        ...
        E(
            ...
            "tool_bitnet_cpp",
            "blocked_by",
            ["docs/23_BITNET_CPP_BRIDGE.md", "docs/MOONSHOT_DEFERRALS.md"],
            0.8,
        ),
        ...
        E(
            ...
            "metric_energy_proxy_ratio",
            "implements",
            ["docs/14_HARDWARE_AND_ENERGY.md", "results/energy_bound.json"],
            0.9,
        ),
