...
def build_nodes() -> list[dict[str, Any]]:
    return [
        ...
        N(
            ...
            "OpenGap",
            "Optional browser pedagogy (W2.T06); Lane F open PR — not on main yet; not blocking v1.0 core.",
            [
                "docs/MOONSHOT_DEFERRALS.md",
        ...
        N(
            ...
            "OpenGap",
            "Schema ADR + hashes + ternary meta + safetensors — Lane B open PR; not merged yet.",
            [
                "docs/MOONSHOT_DEFERRALS.md",
        ...
        N(
            ...
            "OpenGap",
            "distill_sketch.py on main; Lane A extends distill — full BitDistill-scale not a golden.",
            [
                "docs/MOONSHOT_DEFERRALS.md",
        ...
        N(
            ...
            "OpenGap",
            "wheels.yml + docs ready; Lane C dry-run open. First bnn-lab upload needs human Trusted Publisher.",
            [
        ...
        N(
            ...
            "Hardware",
            "Browser pedagogy target; Lane F open PR — not shipped as gate.",
            [
                "docs/MOONSHOT_DEFERRALS.md",
                "https://github.com/KanakMalpani/Binary-Neural-Networks/pull/24",
            ],
        ...
        N(
            ...
            "OpenGap",
            "Sensitivity scores exist (W3.T05); full search W3.T06 in Lane A open PR — no invented goldens.",
            [
                "docs/MOONSHOT_DEFERRALS.md",
        ...
        N(
            ...
            "OpenGap",
            "Prefer thin pin + bridge recipes over full submodule. Lane I open PR hardens pins.",
            [
                "docs/MOONSHOT_DEFERRALS.md",
                "docs/23_BITNET_CPP_BRIDGE.md",
                "https://github.com/KanakMalpani/Binary-Neural-Networks/pull/17",
